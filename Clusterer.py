...
from sklearn.cluster import KMeans, DBSCAN, FeatureAgglomeration, MiniBatchKMeans
...
class Clusterer(object):
    ...
    def cluster_kmeans(self, vectors, reduced_vectors=None, console_output=True, file_output=True,feature_names=None):
        km = MiniBatchKMeans(n_clusters=self.k, init='k-means++', max_iter=100, n_init=10, verbose=False)
        ...
        if console_output == True: # and feature_names != None:
            output = self.kmeans_console_output(feature_names)
